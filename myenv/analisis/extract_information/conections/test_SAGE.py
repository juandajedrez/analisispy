...
link_SAGE = "https://ieeexplore-ieee-org.crai.referencistas.com/search/searchresult.jsp?action=search&newsearch=true"
...
def createLinkExtractInformation(pageNumber):
    link_extractInformation = f"https://journals-sagepub-com.crai.referencistas.com/action/doSearch?field1=AllField&text1=IA&publication=&Ppub=&access=&pageSize=100&startPage="+str(pageNumber)
...
def extract_information(page: Page):
    ...
    results = []
    for i in range(0, 10):  # Asegúrate de que el rango sea correcto
        # Navigate to the desired URL
